...
module alu_control(
    ...
    // ALU Op
        ...
        /*  Radd = 2'b10,
            ...
            Rslt = 2'b10; */
                  ...
                  lwsw = 2'b00, //since LW and SW use the same bit pattern, only way to store them as a paramter
   ...
   // ALU Control Inputs Designation
        parameter 
                  ALUadd = 3'b010,  //for R-type instructions
                  ALUsub = 3'b110,
                  ALUand = 3'b000,
                  ALUor = 3'b001,
                  ALUslt = 3'b111,
        ...
        //and ALU output is 32 x's 
                  unknown = 2'b11, //for invalid opcode, ALUop = 2'b11
                  ALUx = 3'b011;
